...
export function UsersRoles() {
  ...
  const roleStats = [
    ...
    { role: "Faculty", userCount: users.filter(u => u.role === "FACULTY").length, color: "#1D6FA3" },
    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-[#dd7230] text-white rounded-lg hover:bg-[#dd7230] transition-colors shadow-sm cursor-pointer active:scale-95"
        >
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#dd7230]" 
              />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <select 
                ...
                className="sm:w-40 px-4 py-3 bg-white border border-gray-200 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#dd7230] cursor-pointer hover:bg-gray-50"
              >
          ...
          <div className="bg-white rounded-2xl max-w-xl w-full shadow-2xl overflow-hidden">
            ...
            <form onSubmit={handleAddUserSubmit} className="p-6 space-y-5">
              <div>
                ...
                <input type="text" name="name" value={addUserData.name} onChange={handleAddUserChange} className="w-full px-4 py-3 bg-[#F5F7FA] border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#dd7230]" placeholder="e.g., Jane Doe" />
              </div>

              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Email Address</label>
                <input type="email" name="email" value={addUserData.email} onChange={handleAddUserChange} className="w-full px-4 py-3 bg-[#F5F7FA] border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#dd7230]" placeholder="jane.doe@ctu.edu.ph" />
              </div>

              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">System Role</label>
                <select name="role" value={addUserData.role} onChange={handleAddUserChange} className="w-full px-4 py-3 bg-[#F5F7FA] border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#dd7230] cursor-pointer">
              ...
              <div>
                ...
                <input type="password" name="password" value={addUserData.password} onChange={handleAddUserChange} className="w-full px-4 py-3 bg-[#F5F7FA] border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#dd7230]" placeholder="Enter secure password" />
              </div>
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button type="submit" disabled={isCreating} className="flex-1 px-5 py-3 text-sm font-bold bg-[#dd7230] text-white rounded-xl hover:bg-[#dd7230] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer">
