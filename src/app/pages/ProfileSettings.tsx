...
import { User, Lock, Shield, CheckCircle, AlertCircle, Loader2, Mail, BookOpen, Save, LogOut } from "lucide-react";
...
export function ProfileSettings() {
  ...
  // Profile State - We now use a unified 'program' state
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          {/* PROFILE SUMMARY CARD (Flat Design) */}
              ...
              <form onSubmit={handleProfileUpdate} className="p-6 space-y-5">
                ...
                <div className="pt-2 flex justify-end">
                  <button
                    ...
                    className="px-5 py-2 bg-[#1D6FA3] text-white text-sm rounded-lg hover:bg-[#0B3C5D] transition-colors disabled:opacity-50 font-medium flex items-center gap-2"
                  >
              ...
              <form onSubmit={handlePasswordChange} className="p-6 space-y-4">
                ...
                <div className="pt-4 flex justify-end">
                  <button
                    ...
                    className="px-5 py-2 bg-[#006837] text-white text-sm rounded-lg hover:bg-[#00542c] transition-colors disabled:opacity-50 font-medium flex items-center gap-2"
                  >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/40 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white p-8 rounded-2xl shadow-xl max-w-sm w-full text-center animate-in zoom-in-95 duration-300 mx-4">
            ...
            <button 
              ...
              className="w-full py-2.5 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center gap-2 text-sm"
            >
