...
export function AuditTrail() {
  ...
  useEffect(() => {
    const fetchAuditData = async () => {
      ...
      try {
        ...
        // Future tabs (access, versions, system) will be fetched here later!
      } catch (error) {
  ...
  // Search Filter
  const filteredQueries = queryLogs.filter(log => 
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-[#FDB913]">
          <h3 className="text-3xl font-bold text-[#FDB913] mb-2">--</h3>
        ...
        <div className="p-6 border-b border-gray-100 bg-[#F9FAFB]">
          <div className="flex flex-col md:flex-row gap-4 justify-between mb-6">
            ...
            <div className="flex gap-3">
              ...
              <button className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
